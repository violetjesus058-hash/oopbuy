  ...
  <main class="modern-home">
    <section class="hero-section">
      <div class="page-container hero-content">
        ...
        <h1>Oopbuy Spreadsheet <span>2026</span></h1>
        <p class="hero-copy">
          Discover organized Oopbuy finds across clothing, shoes, pants, hats, accessories and electronics,
        ...
        <div class="hero-actions">
          <div class="cta-preview-wrap cta-preview-spreadsheet">
            <div class="cta-preview-card" aria-hidden="true">
              <img src="/images/oopbuy-spreadsheet-preview.png" alt="Oopbuy Spreadsheet preview showing curated product categories and shopping links" title="Oopbuy Spreadsheet preview" />
          ...
          <div class="cta-preview-wrap cta-preview-shopping">
            <div class="cta-preview-card" aria-hidden="true">
              <img src="/images/oopbuy-shopping-preview.png" alt="Oopbuy shopping preview showing product categories and item options" title="Oopbuy shopping preview" />
    ...
    <section id="essential-guides" class="section section-muted essential-guides">
      <div class="page-container">
        <div class="section-heading section-heading-left guides-heading">
          ...
          <p>New to Oopbuy? These short guides explain how the platform works, what the spreadsheet is for and how to begin with a clearer plan.</p>
        </div>
    ...
    <section id="community-research" class="section section-research">
      <div class="page-container research-card">
        <div>
          <p class="section-kicker">Beginner workflow</p>
          <h2>Move from curated finds to a careful first order.</h2>
          <p class="research-card-copy">Use the OopBuy guide to connect Spreadsheet discovery with seller checks, packaging choices, actual-versus-volumetric weight, warehouse timing and a small-order checklist.</p>
          <a href="/blog/oopbuy-community-buying-guide/" class="research-card-link">Read the OopBuy research guide <span aria-hidden="true">→</span></a>
        </div>
        <div class="research-card-note">
          <strong>OopBuy community research</strong>
...
const guideCards = [
  ...
  },
  {
    ...
    title: 'What Is the Oopbuy Spreadsheet?',
