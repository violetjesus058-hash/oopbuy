// ============================================================
// Oopbuy Spreadsheet Site Configuration
...
export const siteConfig = {
  ...
  brand: {
    ...
    description: 'Independent resource for Oopbuy Spreadsheet shoppers. Product guides, category breakdowns, sizing tips, and spreadsheet access — organized in one place.',
    primaryColor: '#8B0000',
    accentColor: '#d4af37',
    logoText: 'Oopbuy Spreadsheet',
  },
  ...
  categories: [
    {
      id: 'clothes',
      name: 'Oopbuy Clothing Spreadsheet',
      icon: '',
    ...
    {
      id: 'accessories',
      name: 'Oopbuy Accessories Spreadsheet',
      icon: '',
    ...
    {
      id: 'electronics',
      name: 'Oopbuy Electronics Spreadsheet',
      icon: '',
  ...
  seo: {
    ...
    title: 'Oopbuy Spreadsheet 2026 - Oopbuy Finds, Category Guides and Product Research',
    description: 'Explore Oopbuy Spreadsheet 2026 through organized Oopbuy finds, category overviews, focused guides and direct spreadsheet access.',
    keywords: ['oopbuy spreadsheet 2026', 'oopbuy spreadsheet', 'oopbuy finds', 'clothing spreadsheet', 'shoes spreadsheet', 'pants spreadsheet', 'hats spreadsheet', 'accessories spreadsheet', 'electronics spreadsheet'],
    ga4: 'G-6SJ0909VMP',
  },
