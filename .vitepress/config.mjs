...
export default defineConfig({
  ...
  head: [
    ...
    ['script', { async: '', src: 'https://www.googletagmanager.com/gtag/js?id=G-6SJ0909VMP' }],
    ['script', {}, `
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
      gtag('config', 'G-6SJ0909VMP');
    `],
  ...
  srcExclude: [
    ...
    'blog/oopbuy-article-prompt.md',
    'blog/oopbuy-internal-link-rules.md',
    'blog/oopbuy-product-reference.md',
    'blog/oopbuy-review-report.md',
    'blog/oopbuy-topic-list.md',
